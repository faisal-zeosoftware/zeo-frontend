...
@Component({
  selector: 'app-resignation-email-template-edit',
  templateUrl: './resignation-email-template-edit.component.html',
  styleUrl: './resignation-email-template-edit.component.css'
})
export class ResignationEmailTemplateEditComponent {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<ResignationEmailTemplateComponent>,

    private ref: MatDialogRef<ResignationEmailTemplateComponent>,
  ...
  updateResignationTemplate() {
    ...
    this.DepartmentServiceService.updateResignationEmailTemplate(
