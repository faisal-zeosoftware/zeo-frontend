...
@Component({
  ...
  styleUrl: './airticket-allocation.component.css'
})
export class AirticketAllocationComponent {
            ...
            try {
              ...
              if (Array.isArray(permissionsData) && permissionsData.length > 0) {
                ...
                if (firstItem.is_superuser) {
                  ...
                  this.hasAddPermission = this.checkGroupPermission('add_airticketallocation', groupPermissions);
                  console.log('Has add permission:', this.hasAddPermission);
                  
                  this.hasEditPermission = this.checkGroupPermission('change_airticketallocation', groupPermissions);
                  console.log('Has edit permission:', this.hasEditPermission);
    
                 this.hasDeletePermission = this.checkGroupPermission('delete_airticketallocation', groupPermissions);
                 console.log('Has delete permission:', this.hasDeletePermission);
    
  
                  this.hasViewPermission = this.checkGroupPermission('view_airticketallocation', groupPermissions);
  ...
  return groupPermissions.some(permission => permission.codename === codeName);
        ...
        loadUsers(): void {
          ...
          CreateAirticketAllocation(): void {
            ...
            this.employeeService.registerAirTicketAllocation(companyData).subscribe(
              (response) => {
                console.log('Registration successful', response);
                    alert('airticket  has been allocated ');
