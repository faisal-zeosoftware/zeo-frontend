...
@Component({
  selector: 'app-doc-req-emailtemplate-edit',
  templateUrl: './doc-req-emailtemplate-edit.component.html',
  styleUrl: './doc-req-emailtemplate-edit.component.css'
})
export class DocReqEmailtemplateEditComponent {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DocReqEmailtemplateEditComponent>,

    private ref: MatDialogRef<DocReqEmailtemplateEditComponent>,
