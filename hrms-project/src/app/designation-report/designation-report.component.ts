          ...
          if (isSuperuser || isEssUser) {
            ...
            if (selectedSchema) {
                ...
                if (Array.isArray(permissionsData) && permissionsData.length > 0) {
                  ...
                  if (firstItem.is_superuser) {
                    ...
                    console.log('Group Permissions:', groupPermissions);
                      ...
                      this.hasViewPermission = this.checkGroupPermission('view_designtn_report', groupPermissions);
              ...
              //    console.log('Has edit permission:', this.hasEditPermission);
                 ...
                 this.hasExportPermission = this.checkGroupPermission('export_designtn_report', groupPermissions);
