...
export class GratuityComponent {
  ...
  minimum_value: any = '';
  maximum_value: any = '';
  resignation_days: any = '';
  termination_days: any = '';
            ...
            try {
              ...
              if (Array.isArray(permissionsData) && permissionsData.length > 0) {
                ...
                if (firstItem.is_superuser) {
                  ...
                  this.hasAddPermission = this.checkGroupPermission('add_gratuitytable', groupPermissions);
                  console.log('Has add permission:', this.hasAddPermission);
                  
                  this.hasEditPermission = this.checkGroupPermission('change_gratuitytable', groupPermissions);
                  console.log('Has edit permission:', this.hasEditPermission);
    
                 this.hasDeletePermission = this.checkGroupPermission('delete_gratuitytable', groupPermissions);
                 console.log('Has delete permission:', this.hasDeletePermission);
    
  
                  this.hasViewPermission = this.checkGroupPermission('view_gratuitytable', groupPermissions);
        ...
        loadUsers(): void {
          ...
          CreateLoanType(): void {
            ...
            const companyData = {
              ...
              resignation_days:this.resignation_days,
            ...
            this.employeeService.registerGratuity(companyData).subscribe(
              (response) => {
...
deleteSelectedGratuity() { 
  ...
  if (selectedEmployeeIds.length === 0) {
    alert('No Gratuity selected for deletion.');
    return;
  }
...
updateAssetType(): void {
  ...
  this.employeeService.updateGratuity(this.editAsset.id, this.editAsset).subscribe(
    (response) => {
      alert(' Gratuity  updated successfully!');
      this.closeEditModal();
      window.location.reload();
    },
(error) => {
