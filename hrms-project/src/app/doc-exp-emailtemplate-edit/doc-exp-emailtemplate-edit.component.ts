...
@Component({
  selector: 'app-doc-exp-emailtemplate-edit',
  templateUrl: './doc-exp-emailtemplate-edit.component.html',
  styleUrl: './doc-exp-emailtemplate-edit.component.css'
})
export class DocExpEmailtemplateEditComponent {
    ...
    constructor(
      ...
      private dialogRef: MatDialogRef<DocExpEmailtemplateEditComponent>,
  
      private ref:MatDialogRef<DocExpEmailtemplateEditComponent>,
  ...
  updateTemplate() {
    if (!this.templateData.template_name || !this.templateData.subject) {
