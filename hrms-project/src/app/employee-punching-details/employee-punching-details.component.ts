...
@Component({
  selector: 'app-employee-punching-details',
  templateUrl: './employee-punching-details.component.html',
  styleUrl: './employee-punching-details.component.css'
})
export class EmployeePunchingDetailsComponent {
