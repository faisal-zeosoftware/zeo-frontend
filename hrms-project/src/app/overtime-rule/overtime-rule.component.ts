...
@Component({
  selector: 'app-overtime-rule',
  templateUrl: './overtime-rule.component.html',
  styleUrl: './overtime-rule.component.css'
})
export class OvertimeRuleComponent {
              ...
              try {
                ...
                if (Array.isArray(permissionsData) && permissionsData.length > 0) {
                  ...
                  if (firstItem.is_superuser) {
                    ...
                    this.hasAddPermission = this.checkGroupPermission('add_overtimerule', groupPermissions);
                    console.log('Has add permission:', this.hasAddPermission);
                    
                    this.hasEditPermission = this.checkGroupPermission('change_overtimerule', groupPermissions);
                    console.log('Has edit permission:', this.hasEditPermission);
      
                   this.hasDeletePermission = this.checkGroupPermission('delete_overtimerule', groupPermissions);
                   console.log('Has delete permission:', this.hasDeletePermission);
      
                    this.hasViewPermission = this.checkGroupPermission('view_overtimerule', groupPermissions);
...
CreateOverTimeRule(): void {
  this.registerButtonClicked = true;

  const formData = new FormData();
  // ✅ EXACT backend field names
  formData.append('rule_type', this.rule_type);
  formData.append('base_type', this.base_type);
  formData.append('threshold_hours', this.threshold_hours);
  formData.append('order', this.order);

  formData.append('policy', this.policy);

  formData.append('is_active', String(this.is_active));
  formData.append('is_extended', String(this.is_extended));


  this.employeeService.registerOverTimeRule(formData).subscribe(
    (response) => {
      console.log('Registration successful', response);
      alert('OverTime Rule has been added');
