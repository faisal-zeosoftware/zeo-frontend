...
@Component({
  ...
  templateUrl: './asset-escalation.component.html',
  styleUrl: './asset-escalation.component.css'
})
   ...
   this.dataSubscription = combineLatest([
    ...
    if (schema) {
                  ...
                  try {
                    ...
                    if (Array.isArray(permissionsData) && permissionsData.length > 0) {
                      ...
                      if (firstItem.is_superuser) {
                        ...
                        this.hasAddPermission = this.checkGroupPermission('add_asset_escalation', groupPermissions);
                        console.log('Has add permission:', this.hasAddPermission);
          
                       this.hasDeletePermission = this.checkGroupPermission('delete_asset_escalation', groupPermissions);
                       console.log('Has delete permission:', this.hasDeletePermission);
          
                        this.hasEditPermission = this.checkGroupPermission('change_asset_escalation', groupPermissions);
                        console.log('Has edit permission:', this.hasEditPermission);
        
                        this.hasViewPermission = this.checkGroupPermission('view_asset_escalation', groupPermissions);
                        console.log('Has view permission:', this.hasViewPermission);

                        this.hasExportPermission = this.checkGroupPermission('export_asset_escalation', groupPermissions);
      ...
      resetSelectedGeneralReq() {
        ...
        if (confirm('Are you sure you want to reset the selected General Request(s)?')) {
          ...
          selectedIds.forEach(id => {
            this.employeeService.resetAssetEsc(id).subscribe(
              () => {
      ...
      updateAssetType(): void {
        ...
        this.employeeService.updateAssetEsc(this.editAsset.id, this.editAsset).subscribe(
          (response) => {
   ...
   this.dataSubscription = combineLatest([
    ...
    if (schema) {
        ...
        console.log("Mapped employee_id:", this.editAsset.escalate_to);
                ...
                registerGeneralreq() {
                  ...
                  this.DepartmentServiceService
                      .updateEscalationLevelAsset(selectedSchema, levelId, payload)
                      .subscribe(
                        (res) => {
      ...
      onRequestTypeChange(event: any) {
        ...
        this.DepartmentServiceService.getEscalationLevelsAsset(selectedSchema, selectedTypeId)
          .subscribe(
            (result: any) => {
