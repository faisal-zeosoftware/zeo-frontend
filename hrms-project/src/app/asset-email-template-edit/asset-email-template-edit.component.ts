...
@Component({
  selector: 'app-asset-email-template-edit',
  templateUrl: './asset-email-template-edit.component.html',
  styleUrl: './asset-email-template-edit.component.css'
})

export class AssetEmailTemplateEditComponent {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AssetEmailTemplateEditComponent>,

    private ref: MatDialogRef<AssetEmailTemplateEditComponent>,
  ...
  updateLoanTemplate() {
    ...
    this.DepartmentServiceService.updateAssetEmailTemplate(
