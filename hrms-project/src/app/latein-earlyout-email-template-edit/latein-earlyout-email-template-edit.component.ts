...
@Component({
  selector: 'app-latein-earlyout-email-template-edit',
  templateUrl: './latein-earlyout-email-template-edit.component.html',
  styleUrl: './latein-earlyout-email-template-edit.component.css'
})
export class LateinEarlyoutEmailTemplateEditComponent {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<LateinEarlyoutEmailTemplateComponent>,

    private ref: MatDialogRef<LateinEarlyoutEmailTemplateComponent>,
  ...
  Designation: this.templateData.Designation || [],
    ...
    this.companyservice.updateLateInEarlyOutEmailTemplate(
