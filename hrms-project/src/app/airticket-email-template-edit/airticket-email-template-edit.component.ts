...
@Component({
  selector: 'app-airticket-email-template-edit',
  templateUrl: './airticket-email-template-edit.component.html',
  styleUrl: './airticket-email-template-edit.component.css'
})
export class AirticketEmailTemplateEditComponent {
      ...
      constructor(
        ...
        private dialogRef: MatDialogRef<AirticketEmailTemplateComponent>,
    
        private ref:MatDialogRef<AirticketEmailTemplateComponent>,
    ...
    updateLoanTemplate() {
      ...
      this.DepartmentServiceService.updateAirticketEmailTemplate(
