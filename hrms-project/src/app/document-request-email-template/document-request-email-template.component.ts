...
export class DocumentRequestEmailTemplateComponent {
  ...
  ngOnInit(): void {
    ...
    this.loadCAtegory();
    this.loadDesignations(); // Call the method on component init
              ...
              try {
                ...
                if (Array.isArray(permissionsData) && permissionsData.length > 0) {
                  ...
                  if (firstItem.is_superuser) {
                    ...
                    this.hasAddPermission = this.checkGroupPermission('add_docrequestemailtemplate', groupPermissions);
                    console.log('Has add permission:', this.hasAddPermission);

                    this.hasEditPermission = this.checkGroupPermission('change_docrequestemailtemplate', groupPermissions);
                    console.log('Has edit permission:', this.hasEditPermission);

                    this.hasDeletePermission = this.checkGroupPermission('delete_docrequestemailtemplate', groupPermissions);
                    console.log('Has delete permission:', this.hasDeletePermission);


                    this.hasViewPermission = this.checkGroupPermission('view_docrequestemailtemplate', groupPermissions);
...
toggleAllDesignations(): void {
  ...
  fetchEmployees(schema: string, branchIds: number[]): void {
    this.isLoading = true;
    this.DepartmentServiceService.getEmailTemplatesDocReqNew(schema, branchIds).subscribe({
      next: (data: any) => {
