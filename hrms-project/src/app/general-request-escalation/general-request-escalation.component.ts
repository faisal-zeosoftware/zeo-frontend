...
@Component({
  selector: 'app-general-request-escalation',
  templateUrl: './general-request-escalation.component.html',
  styleUrl: './general-request-escalation.component.css'
})
export class GeneralRequestEscalationComponent {
        ...
        loadUsers(): void {
          ...
          registerGeneralreq() {
            ...
            this.DepartmentServiceService
                .updateEscalationLevel(selectedSchema, levelId, payload)
                .subscribe(
                  (res) => {
...
onRequestTypeChange(event: any) {
  ...
  this.DepartmentServiceService.getEscalationLevels(selectedSchema, selectedTypeId)
    .subscribe(
      (result: any) => {
